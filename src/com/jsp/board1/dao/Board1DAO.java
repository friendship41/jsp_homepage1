package com.jsp.board1.dao;

import com.jsp.board1.vo.Board1VO;
...
public class Board1DAO
{
    ...
    private static Board1DAO board1DAO;

    public static Board1DAO getInstance()
    {
        if(board1DAO == null)
        {
            synchronized (Board1DAO.class)
            {
                board1DAO = new Board1DAO();
            }
        }
        return board1DAO;
    }
    ...
    public void insertNewBoard1(Board1VO board1VO)
    {
        Connection con = null;
